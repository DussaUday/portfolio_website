      ...
      <div className="scanlines">
        <header className="bg-black border-b-2 border-cyan-400 py-4 sticky top-0 z-50">
          <div className="container mx-auto px-4 flex justify-between items-center">
            ...
            <button
              id="menu-toggle"
              className="md:hidden text-cyan-400 focus:outline-none hover:text-white p-2 rounded transition-colors duration-300"
            ...
            <nav className="hidden md:flex space-x-8">
              {navLinks.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="text-lg hover:text-white hover:underline decoration-cyan-400 transition-colors duration-300"
          ...
          <div
            id="mobile-menu"
            className={`md:hidden bg-black border-t-2 border-cyan-400 flex-col space-y-2 px-4 py-4 absolute top-full left-0 right-0 z-40 ${isMenuOpen ? 'flex' : 'hidden'} transition-all duration-300`}
          >
            {navLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="text-lg hover:text-white hover:underline decoration-cyan-400 py-2 transition-colors duration-300"
                onClick={() => handleNavClick(link.href)}
              >
                {link.label}
              </a>
              ...
              {resumeUrl ? (
                <div className="flex justify-center">
                  <a
                    ...
                    className="bg-cyan-400 text-gray-900 px-8 py-4 rounded-full hover:bg-gray-900 hover:text-cyan-400 hover:glow-hover transition-all"
                  >
                    Download Resume (PDF)
                  </a>
                </div>
          ...
          <section id="contact" className="mb-16 scroll-mt-24">
            <div className="bg-gray-800 border-2 border-cyan-400 p-8 rounded-lg text-center shadow-lg shadow-cyan-400/20">
              ...
              <div className="flex justify-center space-x-8 mb-6">
                {email && (
                  <a href={`mailto:${email}`} className="text-3xl text-cyan-400 hover:text-white hover:scale-110 transition-transform">
                ...
                {github && (
                  <a href={github} target="_blank" rel="noopener noreferrer" className="text-3xl text-cyan-400 hover:text-white hover:scale-110 transition-transform">
                ...
                {linkedin && (
                  <a href={linkedin} target="_blank" rel="noopener noreferrer" className="text-3xl text-cyan-400 hover:text-white hover:scale-110 transition-transform">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="currentColor" viewBox="0 0 24 24">
