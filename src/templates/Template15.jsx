...
export function Template15({ components }) {
  const {
    name = 'Your Name',
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-cyan-400 font-mono">
      ...
      <div className="scanlines">
        <header className="bg-gray-800 text-cyan-400 py-4 sticky top-0 z-50 border-b-2 border-cyan-400">
        ...
        <main className="container mx-auto px-4 py-12">
          <section id="profile" className="mb-16 scroll-mt-24">
            <div className="bg-gray-800 p-8 border-2 border-cyan-400 terminal-effect">
              <h2 className="text-4xl font-bold mb-6 text-center glitch-effect">About Me</h2>
              <div className="flex flex-col md:flex-row items-center gap-8">
                {profilePic ? (
                  <img
                    src={profilePic}
                    alt="Profile"
                    className="w-40 h-40 rounded-none object-cover border-2 border-cyan-400 hover:glitch-effect"
                    onError={e => handleImageError(e, 'profile')}
                  />
                ) : (
                  <div className="w-40 h-40 bg-gray-700 flex items-center justify-center text-gray-400 border-2 border-cyan-400">No Image</div>
                )}
                <div className="text-center md:text-left">
                  <h3 className="text-3xl font-semibold mb-3 glitch-effect">{name}</h3>
          ...
          <section id="skills" className="mb-16 scroll-mt-24">
            <div className="bg-gray-800 p-8 border-2 border-cyan-400 terminal-effect">
              <h2 className="text-4xl font-bold mb-6 text-center glitch-effect">Skills</h2>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {skills.length > 0 ? (
                  skills.map((skill, index) => (
                    <div key={index} className="bg-gray-900 p-4 border border-cyan-400 text-center font-medium hover:glitch-effect">
                      {skill}
                    </div>
                  ))
                ) : (
                  <p className="text-center col-span-full text-cyan-300">No skills listed.</p>
                )}
              </div>
            </div>
          </section>
          ...
          <section id="projects" className="mb-16 scroll-mt-24">
            <div className="bg-gray-800 p-8 border-2 border-cyan-400 terminal-effect">
              <h2 className="text-4xl font-bold mb-6 text-center glitch-effect">Projects</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {projects.length > 0 ? (
                  projects.map((project, index) => (
                    <div key={index} className="bg-gray-900 p-6 border border-cyan-400 hover:glitch-effect">
                      {project.image ? (
                        <img
                          src={project.image}
                          alt={project.name}
                        ...
                        <div className="w-full h-48 bg-gray-700 flex items-center justify-center text-gray-400 mb-4">No Image</div>
                      )}
                      <h3 className="text-xl font-semibold mb-2 glitch-effect">{project.name || 'Unnamed Project'}</h3>
                  ...
                  <p className="text-center col-span-full text-cyan-300">No projects listed.</p>
                )}
              </div>
            </div>
          </section>
          ...
          <section id="certificates" className="mb-16 scroll-mt-24">
            <div className="bg-gray-800 p-8 border-2 border-cyan-400 terminal-effect">
              <h2 className="text-4xl font-bold mb-6 text-center glitch-effect">Certificates</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {certificates.length > 0 ? (
                    ...
                    <div key={index} className="bg-gray-900 p-6 border border-cyan-400 hover:glitch-effect">
                      {certificate.image ? (
                        <img
                          ...
                          className="w-full h-48 object-contain mb-4 bg-gray-800"
                          onError={e => handleImageError(e, 'certificate', index)}
                        />
                      ) : (
                        <div className="w-full h-48 bg-gray-700 flex items-center justify-center text-gray-400 mb-4">No Image</div>
                      )}
                      <h3 className="text-xl font-semibold mb-2 glitch-effect">{certificate.title || 'Untitled Certificate'}</h3>
                  ...
                  <p className="text-center col-span-full text-cyan-300">No certificates listed.</p>
                )}
              </div>
            </div>
          </section>
          ...
          <section id="resume" className="mb-16 scroll-mt-24">
            <div className="bg-gray-800 p-8 border-2 border-cyan-400 terminal-effect text-center">
              <h2 className="text-4xl font-bold mb-6 glitch-effect">Resume</h2>
              {resumeUrl ? (
                <div className="flex justify-center">
                  <a
                    href={resumeUrl}
                    download={`${name}_Resume.pdf`}
                    className="bg-cyan-400 text-gray-900 px-8 py-4 border-2 border-white hover:bg-gray-900 hover:text-cyan-400 hover:glitch-effect"
                  >
                    Download Resume (PDF)
                  </a>
                </div>
              ) : (
                <p className="text-cyan-300">No resume uploaded.</p>
              )}
            </div>
          </section>
          ...
          <section id="contact" className="mb-16 scroll-mt-24">
            <div className="bg-gray-800 p-8 border-2 border-cyan-400 terminal-effect text-center">
              <h2 className="text-4xl font-bold mb-6 glitch-effect">Contact Me</h2>
              <div className="flex justify-center space-x-8 mb-6">
                {email && (
                  <a href={`mailto:${email}`} className="text-3xl text-cyan-400 hover:text-white hover:glitch-effect">
                ...
                {github && (
                  <a href={github} target="_blank" rel="noopener noreferrer" className="text-3xl text-cyan-400 hover:text-white hover:glitch-effect">
                ...
                {linkedin && (
                  <a href={linkedin} target="_blank" rel="noopener noreferrer" className="text-3xl text-cyan-400 hover:text-white hover:glitch-effect">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="currentColor" viewBox="0 0 24 24">
