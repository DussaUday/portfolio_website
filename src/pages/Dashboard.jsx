                ...
                >
                  ...
                  <div className="p-4">
                    <Link
                      ...
                      className="w-full flex items-center justify-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors duration-300"
                    >
        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <motion.p 
              ...
              className="text-sm text-gray-500 dark:text-gray-400"
            >
              {portfolios.length} portfolios created
            </motion.p>
          </div>
